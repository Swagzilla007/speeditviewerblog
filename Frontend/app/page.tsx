...
import { Search, Filter, Calendar, User, Tag as TagIcon, Eye } from 'lucide-react'
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Web Dev Blog</h1>
              <p className="text-gray-600 mt-1">Latest tutorials, guides, and insights</p>
            </div>
    ...
    <article className="card hover:shadow-md transition-shadow duration-200">
      ...
      <div className="card-body">
        ...
        <h2 className="text-xl font-semibold text-gray-900 mb-2 line-clamp-2">
          <a href={`/post/${post.slug}`} className="hover:text-primary-600">
            {post.title}
          </a>
        </h2>
