            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contact@speeditviewer.com</p>
                    <p className="text-gray-600">support@speeditviewer.com</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-100 p-3 rounded-lg hover:bg-blue-100 transition-colors">
